...
class Rx:
    def __init__(self, data, arg1, arg2, **kwargs):
        self.threshold_level = kwargs["threshold_level"] if "threshold_level" in kwargs.keys() else 100
        self.test_mode = kwargs["test_mode"] if "test_mode" in kwargs.keys() else False
        self._arg1 = arg1
        self._arg2 = arg2
    ...
    def plot_adc_data_50_all(self):
        ...
        try:
            for i in range(len(self._adc_data_50)):
                ...
                tot.append(x)
        except: Exception("No 50Hz data available")
        return tot
    ...
    def plot_adc_data_hf_all(self):
        ...
        try:
            for i in range(len(self._adc_data_rx)):
                ...
                tot.append(x)
        except: Exception("No hf data available")
        return tot
